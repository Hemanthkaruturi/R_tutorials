...
#data1.head()
data1 = data[['Sector 1','Sector 2','Sector 4','Sector 3','time_stamp_month']]
...
# data1 = data1.reset_index()
# data1.head()
data1 = data[['Sector 1','Sector 2','Sector 4','time_stamp_month']]

#convert time stamp to numeric
data1['time_stamp_month'] = data1['time_stamp_month'].str.replace('-','')
data1['time_stamp_month'] = data1['time_stamp_month'].astype('int')
data1 = data1[['time_stamp_month','Sector 1','Sector 2','Sector 4']]
data1.head()
